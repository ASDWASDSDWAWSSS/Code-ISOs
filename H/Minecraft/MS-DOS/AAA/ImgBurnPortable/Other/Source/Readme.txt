...
user in an INI file next to ImgBurnPortable.exe called ImgBurnPortable.ini.
...
copy AppNamePortable.ini from this directory to ImgBurnPortable.ini next to
ImgBurnPortable.exe. The options in the INI file are as follows:
